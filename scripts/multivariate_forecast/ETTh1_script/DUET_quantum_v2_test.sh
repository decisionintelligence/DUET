...
# 测试量子损失是否帮助模型持续优化
# V2.2：修复谱熵损失问题，使用范数正则化和奇异值多样性损失
...
python ./scripts/run_benchmark.py \
    ...
    --model-hyper-params '{"CI": 1, "batch_size": 64, "d_ff": 1024, "d_model": 512, "dropout": 0.15, "e_layers": 2, "factor": 3, "fc_dropout": 0.1, "horizon": 96, "k": 3, "loss": "MSE", "lr": 0.001, "lradj": "type1", "n_heads": 4, "norm": true, "num_epochs": 100, "num_experts": 4, "patch_len": 48, "patience": 20, "seq_len": 96, "use_quantum_block": true, "use_quantum_parallel": true, "quantum_loss_weight": 1.0}' \
    --deterministic "full" \
    --gpus 0 \
    --num-workers 1 \
    --timeout 300000 \
